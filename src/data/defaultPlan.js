...
export const DEFAULT_PPL_PLAN = {
  ...
  days: [
    ...
    },
    {
      ...
      focus: 'STRENGTH',
      accent: '#9b72cf',
      desc: 'Strength-focused core day. Abs are muscles — train them with progressive overload like everything else. Heavy cable crunches, anti-extension, anti-rotation, and spinal stability. The V-cut is built here.',
      tip: '<strong>Core strength rule:</strong> Progressive overload applies. Add weight to cable crunches every 2–3 weeks. For bodyweight exercises, add reps until you hit 20 — then add load (ankle weights, plate to chest).',
      vol: [{ k: 'RECTUS ABS', v: '14 sets' }, { k: 'OBLIQUES', v: '7 sets' }, { k: 'STABILITY', v: '6 sets' }],
      exercises: [
        {
          ...findEx('cable-crunch'),
          sets: [
            { n: 1, kg: 20, reps: 15, rest: '60s' },
            { n: 2, kg: 25, reps: 12, rest: '60s' },
            { n: 3, kg: 30, reps: 10, rest: '75s' },
            { n: 4, kg: 35, reps: 8, rest: '90s' },
            { n: 5, kg: 35, reps: 8, rest: '—' },
          ],
          prog: 'Add 2.5 kg when all 5 sets are clean. This is your primary strength ab movement — treat it like a compound lift.',
        },
        {
          ...findEx('ab-wheel'),
          sets: [
            { n: 1, kg: 0, reps: 12, rest: '90s', label: 'BW' },
            { n: 2, kg: 0, reps: 10, rest: '90s', label: 'BW' },
            { n: 3, kg: 0, reps: 10, rest: '90s', label: 'BW' },
            { n: 4, kg: 0, reps: 8, rest: '—', label: 'BW' },
          ],
          prog: 'Hit 12 reps on all 4 sets before progressing to a plate on your back or feet-elevated version.',
        },
        {
          ...findEx('hanging-leg-raise'),
          sets: [
            { n: 1, kg: 0, reps: 15, rest: '75s', label: 'BW' },
            { n: 2, kg: 0, reps: 12, rest: '75s', label: 'BW' },
            { n: 3, kg: 0, reps: 12, rest: '75s', label: 'BW' },
            { n: 4, kg: 0, reps: 10, rest: '—', label: 'BW' },
          ],
          prog: 'When all sets hit 15 clean reps: strap ankle weights (2.5–5 kg) and drop back to 10 reps.',
        },
        {
          ...findEx('russian-twist'),
          sets: [
            { n: 1, kg: 10, reps: 20, rest: '60s', label: '10kg plate' },
            { n: 2, kg: 12.5, reps: 16, rest: '60s', label: '12.5kg plate' },
            { n: 3, kg: 15, reps: 14, rest: '75s', label: '15kg plate' },
            { n: 4, kg: 15, reps: 12, rest: '—', label: '15kg plate' },
          ],
          prog: 'Hold plate at arm length — longer moment arm = harder. Add 2.5 kg when all sets are clean.',
        },
        {
          ...findEx('plank'),
          sets: [
            { n: 1, kg: 0, reps: '60s', rest: '60s', label: 'BW' },
            { n: 2, kg: 0, reps: '60s', rest: '60s', label: 'BW' },
            { n: 3, kg: 0, reps: '60s', rest: '—', label: 'BW' },
          ],
          prog: 'Progress: weighted plate on back (10–20 kg) → then feet elevated. Once you can hold 3×60s with 20 kg plate, move to single-arm plank variations.',
        },
        {
          ...findEx('side-plank'),
          sets: [
            { n: 1, kg: 0, reps: '45s/side', rest: '45s', label: 'BW' },
            { n: 2, kg: 0, reps: '45s/side', rest: '45s', label: 'BW' },
            { n: 3, kg: 0, reps: '45s/side', rest: '—', label: 'BW' },
          ],
          prog: 'Build to 60s/side → then stack feet → then add hip lift reps (3×10) for oblique load.',
        },
        {
          ...findEx('bird-dog'),
          sets: [
            { n: 1, kg: 0, reps: 12, rest: '60s', label: 'BW per side' },
            { n: 2, kg: 0, reps: 12, rest: '60s', label: 'BW per side' },
            { n: 3, kg: 0, reps: 10, rest: '—', label: 'BW per side' },
          ],
          prog: 'Add 3s hold at full extension per rep. Progress to banded resistance on the extending leg.',
        },
      ],
    },
    {
